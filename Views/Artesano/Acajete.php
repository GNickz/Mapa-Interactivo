...
<?php
//linea siguiente comentada hace referencia a la conexion con la base de datos que se utilizara en el proyecto ya desplegado
...
<table class="table table-striped table-hover tabla-artesanos">
        ...
        WHERE p.rolid != 1 AND p.status != 2 AND p.municipioid = 1 AND p.telefono != 0";
            ...
            while ($mostrar = mysqli_fetch_array($resultado)) {
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="facebookArtesano"><a href='http://www.facebook.com/<?php echo $mostrar['facebook'] ?>' target='_blank'><?php echo $mostrar['facebook'] ?></a></td>
                        <td class="twitterArtesano"><a href='http://www.twitter.com/<?php echo $mostrar['twitter'] ?>' target='_blank'><?php echo $mostrar['twitter'] ?></a></td>
                        <td class="instagramArtesano"><a href='http://www.instagram.com/<?php echo $mostrar['instagram'] ?>' target='_blank'> <?php echo $mostrar['instagram'] ?></a></td>
